...
namespace PostalCodesForms.Services
{
    public class PostalCodeService
    {
        ...
        public async Task<CityQueryResult> CityQueryAsync(string countryCode, string stateCode, string city)
        {
            using (var client = CreateClient())
            {
                ...
                var result = JsonConvert.DeserializeObject<CityQueryResult>(await response.Content.ReadAsStringAsync());
